...
-(void)awakeFromNib{
    ...
    self.sunImageView.image = [UIImage imageNamed:@"reveal_refresh_sun" inBundle: [YALSunnyRefreshControl internalBundle] compatibleWithTraitCollection: nil];
    self.buildingsImageView.image = [UIImage imageNamed:@"reveal_refresh_foreground" inBundle: [YALSunnyRefreshControl internalBundle] compatibleWithTraitCollection: nil];
